...
#Functions
def get_pod_props(roi,glom_mask,slider,x_start,y_start,xml_counter,xml_contour,count,dist_mpp,area_mpp2):
    #Parameters
    ihc_gauss_sd = 2
    dt_gauss_sd = 1
    min_area = 200
    ...
    #plt.subplot(131), plt.imshow(res), plt.title('res')
    #plt.subplot(132), plt.imshow(1-pas), plt.title('pas')
    #plt.subplot(133), plt.imshow(ihc), plt.title('ihc')
    #plt.show()
